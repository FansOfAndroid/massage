...
//offset小于0时，也要校正
    ...
    private static String[] CHINESEWEEK ={
    ...
    public String Date2Month(){
        ...
        if (monthIndex < 1 || monthIndex > MONTHS) {
            return null;
        }
        return MONTH[monthIndex];
    }

    public String SorLMonth(){
    ...
    public String Date2ChineseWeek(){
        int dayIndex = calendar.get(Calendar.DAY_OF_WEEK);
        if (dayIndex < 1 || dayIndex > WEEKDAYS) {
            return null;
        }
        return CHINESEWEEK[dayIndex - 1];
    }
}
